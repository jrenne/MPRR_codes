...
In several cases, the same objects also appear in the Overleaf project used to typeset the book. In this Bookdown version, the focus is on transparent and reproducible code, with one chapter per block of applications.
